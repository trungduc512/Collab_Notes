...
import { createDocument, getAllRespectedUserDocuments, getSingleUserDocument, deleteDocument, addCollaborator, getAllCollaborators} from '../controllers/doc.controller.js';
...
documentRouter.route('/:documentId').get(validateToken, getSingleUserDocument).delete(validateToken, deleteDocument);
